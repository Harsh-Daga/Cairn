"""Golden-hash tests for canonical serialization (R1)."""

from __future__ import annotations

import pytest

from cairn.util.canonical import CanonicalError, canonical_json, hash_bytes, hash_obj, merkle_hash
...
def test_hash_bytes_golden() -> None:
    assert (
