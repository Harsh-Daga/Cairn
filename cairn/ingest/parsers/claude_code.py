...
from cairn.ingest.normalizer import (
    _EDIT_TOOLS,
    _SKIP_LINE_TYPES,
    args_payload,
    extract_file_path,
...
from cairn.ingest.project_paths import claude_subagent_external_id, path_rel_to_repo
...
def parse_jsonl_file(
    ...
    *,
    ...
    state = _ParserState(repo_root=repo_root)
...
class _ParserState:
    ...
    def consume(self, obj: dict[str, Any], *, line_no: int) -> None:
        ...
        if line_type == "user":
            ...
            self._parse_system(obj, line_no=line_no)
    ...
    def _parse_user(self, obj: dict[str, Any], *, line_no: int) -> None:
        ...
        if tool_results:
            for block in tool_results:
                self._emit_tool_result(block, line_no=line_no)
            return
    ...
    def _parse_assistant(self, obj: dict[str, Any], *, line_no: int) -> None:
        ...
        for block in content:
            ...
            if block.get("type") != "tool_use":
                continue
            self._emit_tool_call(block, line_no=line_no)

    def _parse_system(self, obj: dict[str, Any], *, line_no: int) -> None:
    ...
    def _emit_tool_call(self, block: dict[str, Any], *, line_no: int) -> None:
    ...
    def _emit_tool_result(self, block: dict[str, Any], *, line_no: int) -> None:
